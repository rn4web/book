...
而对于事件处理则仅仅做了透传，最终由React进行处理。

#### 2.2.2.3View组件flex默认样式的故事
...
### 2.2.4 AppRegistry组件
作为business调用React-Native的注册函数，AppRegistry组件承担起了business程序入口的重任。

#### 2.2.2.1AppRegistry组件的设计要求


#### 2.2.2.1AppRegistry组件的关键实现
